...
function App() {
  ...
  return (
    <div className="flex flex-col items-center min-h-screen bg-gray-900 text-white py-10 px-4">
      <div className="title-subtitle-container flex items-center">
        <div className="flex flex-col items-center">
          <h1 className="text-4xl font-bold mb-2 text-center">BabyGroqFood</h1>

          {/* If you've imported snorlaxImage, use: src={snorlaxImage} */}
          <img
      ...
      <div className="w-full max-w-lg space-y-6">
        ...
        <div className="bg-gray-800 p-6 rounded-lg shadow-md space-y-4">
          <div className="flex justify-center">
            ...
            >
              {isRecording ? 'Calculate' : 'Start Recording'}
            </button>
          </div>
          {transcription && (
        ...
        {result && (
          <div>
            <button
              ...
              className="w-full px-6 py-2 rounded-lg bg-green-600 hover:bg-green-700 transition-colors duration-200"
            >
              Show Result
            </button>
          </div>
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-gray-800 p-6 rounded-lg shadow-md text-center">
            ...
            <button
              ...
              className="mt-4 px-6 py-2 rounded-lg bg-red-600 hover:bg-red-700 transition-colors duration-200"
            >
              Close
            </button>
          </div>
